...
_=JBoss Tools Visual Page Editing_ is part of [JBoss Tools](http://jboss.org/tools) from
...
To build _=JBoss Tools Visual Page Editing_ requires specific versions of Java and
...
_=JBoss Tools Visual Page Editing_ is open source, and we welcome anybody that wants to
